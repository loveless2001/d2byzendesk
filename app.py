...
from bottle import route, template, run, static_file, request, response, os
...
def handle_form():
    ...
    if request.POST:
        ...
        user = email + '/token'
        api_token = '4Q0WQyIWFRBcry2u0CVvap4ZAhDH2G93I36wwH1w'
        url = 'https://ggwpdota2.zendesk.com/api/v2/requests.json'
